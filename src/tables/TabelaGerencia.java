...
public class TabelaGerencia extends AbstractTableModel {
    ...
    private final List<ListaGerenciaModel> mList;

    public TabelaGerencia(List<ListaGerenciaModel> pList) {
        mList = pList;

    }

    public TabelaGerencia() {
