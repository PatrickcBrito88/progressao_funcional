...
public class TabelaResumoGerhum extends AbstractTableModel {
    ...
    private final List<ListaMenuGerhumModel> mList;

    public TabelaResumoGerhum(List<ListaMenuGerhumModel> pList) {
        mList = pList;

    }

    public TabelaResumoGerhum() {
