...
public class TabelaFuncionarioSemSetor extends AbstractTableModel {
    ...
    private final List<ListaFuncionarioSemAcessoModel> mList;

    public TabelaFuncionarioSemSetor(List<ListaFuncionarioSemAcessoModel> pList) {
        mList = pList;

    }

    public TabelaFuncionarioSemSetor() {
