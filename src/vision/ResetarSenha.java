...
public class ResetarSenha extends javax.swing.JFrame {
    ...
    public void geraCombo(){
        ...
        try {
            conecta.rs.first();
            do{
               jComboBoxFunc.addItem(conecta.rs.getString("Nome_func"));
    ...
    public ResetarSenha(String banco) {
         this.bancoOf=banco;
    ...
    private void initComponents() {
        ...
        jPanel4.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 90, 30));
        ...
        jPanel4.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 70, 130, 40));

        jComboBoxFunc.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        jPanel4.add(jComboBoxFunc, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 20, 320, 30));
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
          FuncionarioControl func = new FuncionarioControl(bancoOf);
        func.ResetSenha(String.valueOf(jComboBoxFunc.getSelectedItem()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResetarSenha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ResetarSenha(bancoOf).setVisible(true);
            }
        });
    }
