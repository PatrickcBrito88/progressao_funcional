...
public class Tela_Visao_Avaliacao_MenuPrincipal extends javax.swing.JFrame {

    private static String bancoOf;
    ConectaBanco conecta;

    public Tela_Visao_Avaliacao_MenuPrincipal(String banco) {
        this.bancoOf = banco;
        conecta = new ConectaBanco(bancoOf);
        initComponents();
        setDisableCampos();

        geraComboFuncionarios();
        geraComboAvaliador();
        setCampos();
        setAvaliacao();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 96, 30));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel4.setText("Funcionário: ");
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 100, 30));
        ...
        jPanel2.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, 310, 30));
    ...
    public void geraComboFuncionarios() {
        ...
        try {
            if (conecta.rs.first()) {
                do {
                    jComboBox1.addItem(conecta.rs.getString("nome_func"));
                } while (conecta.rs.next());
            }
            jComboBox1.removeItem("Admin");
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Erro ao montar jCombo Funcionario, motivo: " + ex);
        } finally {
            conecta.desconecta();
        }
    ...
    public void geraComboAvaliador() {
        String avaliado = (String.valueOf(jComboBox1.getSelectedItem()));
        ...
        conecta.conexao();
        conecta.executaPesquisaSQL("Select * from nomeavaliadorv where mat_avaliado=" + matAdo);
        try {
            conecta.rs.first();
            do {
                jComboBox2.addItem(conecta.rs.getString("nome_func"));
            } while (conecta.rs.next());

        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Erro, ao montar Combo avaliador, motivo: " + ex);
        } finally {
            conecta.desconecta();
        }
    }
    ...
    public void ImprimeAvaliacao() {
        ...
        String nomeAvaliado = String.valueOf(jComboBox1.getSelectedItem());
    ...
    public void setCampos() {
        String nomeAdo = String.valueOf(jComboBox1.getSelectedItem());
        String nomeAdor = String.valueOf(jComboBox2.getSelectedItem());

        FuncionarioControl funcionarioControle = new FuncionarioControl(bancoOf);
        int matAdo = funcionarioControle.getMatFunc(nomeAdo);
        int matAdor = funcionarioControle.getMatFunc(nomeAdor);
        ...
        String cargoAvaliador = jTextFieldCargoAdo.getText();
        String cargoAvaliado = jTextFieldCargoAdor.getText();
        FuncionarioControl funcionario = new FuncionarioControl(bancoOf);
        int mat = funcionario.getMatFunc(nomeAdo);
    ...
    public void setAvaliacao() {
        ...
        AvaliacaoControl avaliacaoControle = new AvaliacaoControl(bancoOf);
        avaliacaoModelo = avaliacaoControle.getAvaliacaoDados(matAdo, matAdor);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Visao_Avaliacao_MenuPrincipal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tela_Visao_Avaliacao_MenuPrincipal(bancoOf).setVisible(true);
            }
        });
    }
